...
if("TRUE" STREQUAL "TRUE")
  set(car_gazebo_SOURCE_PREFIX /home/yulin/carA_sim_ws/src/car_gazebo)
  set(car_gazebo_DEVEL_PREFIX /home/yulin/carA_sim_ws/devel)
  ...
  set(car_gazebo_INSTALL_PREFIX /home/yulin/carA_sim_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'car_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yulin/carA_sim_ws/src/car_gazebo/${idir}'.  ${_report}")
    endif()
